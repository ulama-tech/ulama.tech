    ...
    items: [
      {
        ...
        description: (
          <>
            ...
            We'll be in touch soon, but reach out to us at <a href="mailto:hello@ulama.tech">hello@ulama.tech</a> if you need anything in the meantime.
          </>
        ),
      },
      {
        ...
        description: (
          <>
            ...
            <a href="mailto:hello@ulama.tech">email us</a>.
          </>
        ),
      },
    ],
