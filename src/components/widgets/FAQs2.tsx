...
const FAQs2 = ({ header, items, id, hasBackground = false }: FAQsProps) => (
  <WidgetWrapper id={id ? id : ''} hasBackground={hasBackground} containerClass="max-w-6xl">
    ...
    <Collapse
      ...
      iconUp={<ChevronUpIcon className="h-6 w-6 text-primary-600 dark:text-slate-200" />}
      iconDown={<ChevronDownIcon className="h-6 w-6 text-primary-600 dark:text-slate-200" />}
    />
  </WidgetWrapper>
);
