...
const carouselData = [
  {
    ...
    description:
      'Powered by Computer Vision and our vetted compliance algorithms, Ulama scans your entire building to uncover code violations.',
    image: carr1,
  },
  {
    id: 2,
    ...
    description:
      'We offer a 1-button sync from Revit, Archichad, SketchUp, Rhino, and IFC file upload for seamless integration with your existing workflows.',
    image: carr2,
  },
  {
    id: 3,
    ...
    subheading: 'Action',
    description:
      'For every code violation, we show you the actual code language and our plain English translation. We give you text and visual feedback so you can act quickly and decisively.',
    image: carr3,
  },
  {
    id: 4,
  ...
  },
  {
    ...
    description:
      "When you're ready to submit your designs for permit approval, our compliance report clearly communicates the compliance of your designs to reviewers.",
    image: carr5,
  },
];
  ...
  return (
    <>
      ...
      >
            ...
            >
              ...
              >
                <h2 className="font-dm-sans text-4xl sm:text-5xl font-semibold text-white leading-tight mb-6">
                  {item.heading} <span className="text-[#2DE1C2]">{item.subheading}</span>
                </h2>
        ...
        {showBottomBar && (
          <div className="fixed bottom-0 left-0 right-0 h-5 bg-secondary z-50 transition-all duration-300 opacity-100 transform translate-y-0"></div>
        )}
      </section>
    </>
  );
