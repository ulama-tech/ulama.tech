          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center">
            ...
            <div className="relative">
              <div className="relative z-10 w-82 md:w-96">
                <Image src={footerimg} alt="Building illustration" width={300} height={300} className="w-full h-full" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="flex-1 lg:flex-none lg:w-1/4">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-10 h-10 rounded flex items-center justify-center">
                  <Image src={logoSrc} alt="Ulama Logo" width={30} height={30} className="w-10 h-10" />
                </div>
