            ...
            <div className='flex flex-col md:flex-row gap-8 md:gap-16'>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li><a href="#" className="text-white hover:text-white transition-colors">Why Us</a></li>
                  ...
                  <li><a href="#" className="text-white hover:text-white transition-colors">Testimonials</a></li>
                </ul>
              </div>
