  ...
  const complianceChallenges = [
    {
      ...
      description:
        'When permit approval is delayed, invoicing is delayed. Ulama helps you get paid on time to maintain consistent cashflow.',
    ...
    },
    {
      ...
      description: 'Navigating building codes in new locations requires expertise that many teams lack.',
      imageUrl: complexRegulatoryRequirementsImage.src,
    },
    {
      id: 4,
      title: 'Legal risks',
      description: 'Non-compliance can result in costly rework, project delays, and disputes.',
      ...
      <div className="relative max-w-7xl mx-auto justify-center items-center flex flex-col">
        ...
        <div className="text-center mb-16 max-w-3xl">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Compliance is boring and costs <span className="text-red-500">millions each year.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {complianceChallenges.map((challenge) => (
            ...
            >
              ...
              />
              {/* Title */}
              <h3 className="text-xl font-medium text-gray-900 mb-1 ">{challenge.title}</h3>
              {/* Description */}
              <p className="text-gray-600  leading-tight">{challenge.description}</p>
            </div>
          ))}
        </div>
      </div>
