      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div className="space-y-6">
          ...
          <p className="text-lg text-gray-600  max-w-md">
            We have a combined 17+ years of experience of working in the AEC space, building cutting-edge software, and
                ...
                <div className="w-12 h-12 bg-secondary cursor-pointer hover:bg-orange-500 transition-all duration-300 flex items-center justify-center ">
                  <Link href="mailto:tyce@ulama.tech" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                      ...
                      />
                      <path
                        d="M15.4638 2.33972L5.69067 10.4857"
                        stroke="white"
                        strokeWidth="1.24315"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      ...
                      <defs>
                        <clipPath id="clip0_990_1454">
                          <rect
                            ...
                            height="17.4041"
                            fill="white"
                            transform="translate(0.220093 0.130005)"
                          />
                        </clipPath>
                      </defs>
                    </svg>
