          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="text-4xl md:text-5xl font-bold leading-tight">
                <span className="text-primary">Architects build for people. We build</span>
              </h3>

              <h3 className="text-4xl md:text-5xl font-bold leading-tight ">
                <span className="text-secondary">for architects.</span>
              </h3>
            </div>
          </div>
