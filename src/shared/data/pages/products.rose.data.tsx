...
export const contentRoseOne: ContentProps = {
  ...
  hasBackground: false,
  content:
    'Missing or inconsistent classification data? With Rose, updating your Revit model is a snap. Rose uses a multimodal AI model to evaluate your Revit families and family instances and updates them with a new normalized name parameter. With consistently named elements, unlock:',
  items: [
    {
    ...
    {
      title: 'Model visualizations utilizing names as layers',
    },
  ],
  image: {
    src: cameraFrontImg,
...
export const featuresRoseOne: FeaturesProps = {
  header: {
    ...
    subtitle:
      "Additional families are coming soon. Email us with the families you'd like to see next!",
  },
  columns: 3,
  items: [
  ...
  items: [
    {
      ...
      description: `Rose uses a multimodal AI model that looks at each Revit family and family instance, updating each with a standardized name in a custom parameter. Unlike other approaches, Rose uses computer vision to understand families and family instances just like you would. Check out our demo video see it in action!`,
...
export const callToActionServices: CallToActionProps = {
  ...
  subtitle: `Drop us a line! We'd love to talk.`,
  callToAction: {
    text: 'Contact us',
